...
def main():
    ...
    # Ignore for the moment since its basrom dataclasses import dataclass, field
    # from typing import Optional
    #
    # import torch
    # from datasets import load_dataset
    ...
    #     trainer.train()
    #
    #     # Ignore for the moment since its based on the PEFT library
    ...
    #     #     model.save_pretrained(output_merged_dir, safe_serialization=True)ed on the PEFT library
    # if script_args.merge_and_push:
    #     output_dir = os.path.join(script_args.output_dir, "final_checkpoints")
    #     trainer.model.save_pretrained(output_dir)
    #
